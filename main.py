...
# hasta el numero ingresado (num) y utilizando el operador modulo comprueba si el numero es par o impar, si este es
# impar sera sumado a la variable suma, luego de terminar el ciclo imprime la suma total de impares
